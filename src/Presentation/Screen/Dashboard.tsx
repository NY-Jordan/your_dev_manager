...
export default function Dashboard() {
  ...
  return (
      ...
      <div className='px-10 dark:bg-slate-950' >
          <div className={'flex justify-between  dark:bg-slate-950 mt-4 mb-2 ' + (isTabletOrMobile ? 'flex-col space-y-4' : '' )}>
              <div>
                <h1 className='text-2xl dark:text-white'>Dasboard</h1>
          ...
          <div className={'flex lg:flex-row  flex-col mb-8 items-center space-x-4 justify-center  content-center'+(isTabletOrMobile ? 'flex-col space-y-8' : "")}>
            ...
            <div style={{ width : isTabletOrMobile ? "100%" : "50%" }} className='rounded-lg  dark:bg-slate-800 dark:border-gray-800 dark:text-white  bg-white border-2 p-2'>
              <div className='mb-4'>
